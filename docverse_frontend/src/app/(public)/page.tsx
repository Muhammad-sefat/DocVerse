...
import { mockBooks, mockCategories, mockUsers, testimonials } from "@/data/mock-data";
...
const authors = mockUsers.filter((u) => u.role === UserRole.AUTHOR).map((u) => ({
  id: u.id,
  name: u.name,
  email: u.email,
  bio: u.bio || "",
        ...
        <div className="page-container relative py-24 md:py-32">
          <div className="hero-content mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-white/70 md:text-xl max-w-2xl mx-auto">
              Your premier digital library platform. Explore thousands of books, borrow instantly, 
              and build your personal digital library with DocVerse.
            </p>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link href="/books">
                <Button size="xl" className="bg-white text-primary-800 hover:bg-white/90 shadow-xl">
        ...
        <div className="page-container">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="section-subtitle">Discover our most popular and highly rated books</p>
            </div>
            <Link
              href="/books"
      ...
      <section ref={categoriesRef} className="section-padding bg-secondary-50">
        <div className="page-container">
          <div className="text-center">
            ...
            <p className="section-subtitle">Explore books across various genres and topics</p>
          </div>
      ...
      <section ref={authorsRef} className="section-padding">
        <div className="page-container">
          <div className="text-center">
            ...
            <p className="section-subtitle">Meet our renowned authors and their amazing works</p>
          </div>
            ...
            {[
              {
                icon: Search,
                title: "Browse",
                description: "Explore our vast collection of books across multiple categories and genres.",
                color: "bg-blue-100 text-blue-600",
              },
              {
                icon: BookOpen,
                title: "Buy or Borrow",
                description: "Purchase your favorite books or borrow them at affordable prices.",
              ...
              <div key={step.title} className="reveal-item text-center">
                ...
                <h3 className="mt-6 text-xl font-semibold text-secondary-900">{step.title}</h3>
                <p className="mt-3 text-secondary-500 leading-relaxed">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section ref={testimonialsRef} className="section-padding">
        <div className="page-container">
          <div className="text-center">
            ...
            <p className="section-subtitle">Join thousands of satisfied readers worldwide</p>
          </div>
      ...
      <section className="section-padding gradient-hero">
        <div className="page-container">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold text-white md:text-4xl">Stay Updated</h2>
            <p className="mt-3 text-lg text-white/70">
              Get the latest book releases, exclusive offers, and reading tips delivered to your inbox.
            </p>
